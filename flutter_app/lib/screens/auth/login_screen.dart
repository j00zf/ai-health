                ...
                Expanded(
                  child: Center(
                    child: SingleChildScrollView(
                      ...
                      child: _buildGlassLoginCard(context),
                    ),
                  ),
                ),
              ],
            ...
            child: Container(
              ...
              decoration: BoxDecoration(
                ...
                gradient: RadialGradient(
                  colors: [const Color(0xff57ebd3).withOpacity(0.7), const Color(0xff7bf1a8).withOpacity(0.0)],
                ),
              ),
            ),
          ),
          Positioned(
            ...
            child: Container(
              ...
              decoration: BoxDecoration(
                shape: BoxShape.circle,
                gradient: RadialGradient(
                  colors: [const Color(0xffff7c54).withOpacity(0.65), const Color(0xffffbe7b).withOpacity(0.0)],
                ),
              ),
            ),
          ),
          Positioned(
            ...
            child: Container(
              ...
              decoration: BoxDecoration(
                shape: BoxShape.circle,
                gradient: RadialGradient(
                  colors: [const Color(0xffb57eff).withOpacity(0.75), const Color(0xffded2f9).withOpacity(0.0)],
                ),
              ),
            ),
          ),
          Positioned(
            ...
            child: Container(
              ...
              decoration: BoxDecoration(
                shape: BoxShape.circle,
                gradient: RadialGradient(
                  colors: [const Color(0xffffb26b).withOpacity(0.55), const Color(0xfffff4e0).withOpacity(0.0)],
                ),
              ),
            ),
          ),
          ...
          child: Column(
            ...
            children: [
              ...
              Row(
                children: [
                  ...
                  const Padding(
                    ...
                    child: Text("OR", style: TextStyle(fontSize: 12, fontWeight: FontWeight.bold, color: Colors.black54)),
                  ),
                  Expanded(child: Divider(color: Colors.black.withOpacity(0.1), thickness: 1)),
                ],
              ),
              ...
              Row(
                mainAxisAlignment: MainAxisAlignment.center,
                children: [
                  Text("Don't have an account? ", style: TextStyle(color: Colors.black.withOpacity(0.5), fontSize: 14)),
                  GestureDetector(
